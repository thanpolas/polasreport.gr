...
CMD ["sh", "-c", "if [ -f Gemfile ]; then bundle exec jekyll serve --host 0.0.0.0 --port 4000 --livereload --watch --safe; else jekyll serve --host 0.0.0.0 --port 4000 --livereload --watch --safe; fi"]
